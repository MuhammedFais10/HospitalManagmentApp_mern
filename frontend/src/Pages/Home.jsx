      ...
      <section>
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text__para ">
                  ...
                  online sheduling tool to select an appoinment time.
                </li>
              </ul>
              <Link to="/">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px] ">
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className="w-5 h-5 lg:w-[34px] lg:h-[36px] flex items-center justify-center bg-yellowColor rounded 
       ...
       text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[500] mt-2 lg:mt-4 rounded-full"
                ...
                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px] ">
                  ...
                  <h4 className="text-[10px] leading-3 lg:leading-[22px] font-[700] text-headingColor">
                    Wayne Collins
                  </h4>
                </div>
              </div>
